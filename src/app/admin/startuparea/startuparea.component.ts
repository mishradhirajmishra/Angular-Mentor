...
@Component({
  selector: 'app-startuparea',
  templateUrl: './startuparea.component.html',
  styleUrls: ['./startuparea.component.css']
})
export class StartupareaComponent implements OnInit {
  ...
  allintfun(){
    this.as.adminAllStartupArea().subscribe(
  ...
  msg:string;
  submit(){
    this.as.adminAddStartupArea(this.intrestData).subscribe(
