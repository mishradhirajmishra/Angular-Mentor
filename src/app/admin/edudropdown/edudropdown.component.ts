...
@Component({
  selector: 'app-edudropdown',
  templateUrl: './edudropdown.component.html',
  styleUrls: ['./edudropdown.component.css']
})
export class EdudropdownComponent implements OnInit {
  ...
  allintfun(){
    this.as.adminAllEduDropDown().subscribe(
  ...
  msg:string;
  submit(){
    this.as.adminAddEduDropDown(this.intrestData).subscribe(
