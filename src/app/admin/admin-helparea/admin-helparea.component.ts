...
@Component({
  selector: 'app-admin-helparea',
  templateUrl: './admin-helparea.component.html',
  styleUrls: ['./admin-helparea.component.css']
})
export class AdminHelpareaComponent implements OnInit {
  ...
  msg:string;
  submit(){
    this.as.adminAddHelpArea(this.intrestData).subscribe(
  ...
  edit(intrest:any){
    this.btnText='Update';
    this.intrestData.id=intrest.id;    this.intrestData.name=intrest.name;this.intrestData.image=intrest.image;
  }
  enable:boolean=true;
  nameData(){
